...
class CalenderEventsServiceProvider extends ServiceProvider
{
    public function __construct($rawData)
    {
        $this->rawData = $rawData;
        $filteredLeaveTypes = ["Homeoffice", "Einheit", "Feiertag", "-", "Tag)"
        ];
    }

    public function parseCalendar($rawICSData)
    {
        $parsedRawData = $this->parseData($this->$rawICSData);
